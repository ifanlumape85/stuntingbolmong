...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pages.user.create', compact('item', 'roles', 'puskesmass'));
    }
    ...
    public function store(UserRequest $request)
    {
        ...
        $user->puskesmas()->attach($request->id_puskesmas);
    ...
    public function edit($id)
    {
        ...
        return view('pages.user.edit', compact('item', 'roles', 'userRole', 'puskesmass'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $item->puskesmas()->sync($request->id_puskesmas);
